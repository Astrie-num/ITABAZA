    ...
    return (
        <View style={styles.container}>
            ...
            <View style = {styles.inputField}>
                ...
                <TextInput placeholder='Your Password' style = {styles.textInput} value={formData.password}
              ...
              <View style = {styles.inputField}>
                <FontAwesome name="lock" size={20} style = {styles.icon}/>
                <TextInput placeholder='Confirm Password' style = {styles.textInput} value={formData.password}
                      onChangeText={(text) => handleChange('password', text)} />
                <FontAwesome name="eye-slash" size={20} style={styles.eyeIcon2}/>
              </View>
            </View>
            <View style={styles.sendBtn}>
              <TouchableOpacity onPress={() => (router.push('/components/SignIn'))} style={styles.sendCont} >
