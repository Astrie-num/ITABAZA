            ...
            <GestureHandlerRootView>
                ...
                <ScrollView style = {styles.container}>
                    <View style = {styles.images}>
                        <View>
                            <TouchableOpacity onPress={() => (router.push('/components/cemetriesMap/oneloveContact'))} style={styles.vendorContainer}>
                                ...
                                <View>
                                    ...
                                    <TouchableOpacity>
                                        <Text style={styles.contact} onPress={() => (router.push('/components/cemetriesMap/oneloveContact'))}>Contact</Text>
                                    </TouchableOpacity>
                                    <TouchableOpacity>
                        ...
                        <View>
                            <TouchableOpacity onPress={() => (router.push('/components/cemetriesMap'))} style={styles.vendorContainer}>
